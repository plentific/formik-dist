...
export interface FormikHelpers<Values> {
    ...
    setTouched: (touched: FormikTouched<Values>, shouldValidate?: boolean) => Promise<void | FormikErrors<Values>> | FormikErrors<Values> | void;
    /** Manually set values object  */
    setValues: (values: React.SetStateAction<Values>, shouldValidate?: boolean) => Promise<void | FormikErrors<Values>> | FormikErrors<Values> | void;
    /** Set value of form field directly */
    setFieldValue: (field: string, value: any, shouldValidate?: boolean) => Promise<void | FormikErrors<Values>> | FormikErrors<Values> | void;
    /** Set error message of a form field directly */
    setFieldError: (field: string, message: string | undefined) => void;
    /** Set whether field has been touched directly */
    setFieldTouched: (field: string, isTouched?: boolean, shouldValidate?: boolean) => Promise<void | FormikErrors<Values>> | FormikErrors<Values> | void;
    /** Validate form values */
    validateForm: (values?: any) => FormikErrors<Values> | Promise<FormikErrors<Values>>;
    /** Validate field value */
    validateField: (field: string) => Promise<string | undefined | void> | string | undefined | void;
    /** Reset form */
...
export interface FormikConfig<Values> extends FormikSharedConfig {
     ...
     */
    validate?: (values: Values, field?: string) => void | object | Promise<FormikErrors<Values>>;
    /** Inner ref */
...
export interface FieldHelperProps<Value> {
    ...
    setValue: (value: Value, shouldValidate?: boolean) => Promise<void | FormikErrors<Value>> | FormikErrors<Value> | void;
    /** Set the field's touched value */
    setTouched: (value: boolean, shouldValidate?: boolean) => Promise<void | FormikErrors<Value>> | FormikErrors<Value> | void;
